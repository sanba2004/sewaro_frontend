...
//   const triggerNativePrint = (modeClass) => {
//     document.body.classList.remove('print-mode-invoice-only', 'print-mode-label-only','print-mode-listing-only');
//     document.body.classList.add(modeClass);
...
//           body.print-mode-invoice-only #dashboard-view-panel,
//           body.print-mode-invoice-only .label-printable-target,
//           body.print-mode-invoice-only .listing-printable-target { display: none !important; }
//           body.print-mode-invoice-only .invoice-printable-target { display: block !important; }
//           body.print-mode-label-only #dashboard-view-panel,
//           body.print-mode-label-only .invoice-printable-target,
//           body.print-mode-label-only .listing-printable-target { display: none !important; }
//           body.print-mode-label-only .label-printable-target { display: block !important; }
//           body.print-mode-listing-only #dashboard-view-panel,
//           body.print-mode-listing-only .invoice-printable-target,
//           body.print-mode-listing-only .label-printable-target { display: none !important; }
//           body.print-mode-listing-only .listing-printable-target { display: block !important; }
//         }

//       .invoice-printable-target, .label-printable-target, .listing-printable-target { display: none; }
...
//         <button type="button" onClick={() => triggerNativePrint('print-mode-listing-only')} style={{ background: '#1f7a3d', color: '#fff', border: 'none', padding: '12px 20px', cursor: 'pointer', fontWeight: 'bold', borderRadius: '4px' }}>📋 Listing</button>
//       </div>
...
//       </div>
//       <div className="listing-printable-target">
//         <PackingList previewTrackingId={data?.tracking_id} packages={mappedPackages} senderInfo={mappedSenderInfo} receiverInfo={mappedReceiverInfo} />
//       </div>
//     </div>
//   );
// }
...
export default function ShipmentDetailView({ trackingId, onClose, user }) {
  ...
  return (
    <div className="invoice-display-container" style={{ maxWidth: '1000px', margin: '0 auto', padding: '10px' }}>
      ...
      {/* 📱 Mobile-only responsive tweaks. Print visibility rules live entirely in ShipmentDetail.css now. */}
      <style>{`
        @media (max-width: 768px) {
          .invoice-card { padding: 15px !important; }
          .detail-action-header-row { flex-direction: column; gap: 8px !important; }
