        ...
        {step === 1 && (
          <>
            <div className="tab-switcher">
              <button className="tab-btn active">Enter Address Details</button>
              {/* <button className="tab-btn">Set on Map</button> */}
            </div>
            ...
            <div className="form-grid">
              ...
              <div className="form-column">
                ...
                <label>Verification ID (Optional):</label>
                  {/* We set the value to an empty string to represent the placeholder */}
                  <select 
                  ...
                  {/* <div>
                    ...
                    {senderInfo.idFrontUrl && (
                      <div className="image-preview">
                        <img src={senderInfo.idFrontUrl} alt="Front Preview" style={{ width: '100px' }} />
                        <span className="status-tag">Saved in Cache</span>
                      </div>
                    )}
                    <label>Upload ID Back</label>
                    <input type="file" onChange={(e) => handleUpload(e, 'back')} />
                  </div> */}
                  <div className="id-upload-row">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                      <input 
                        ...
                        accept="image/*"
                      />
                      {/* Cross: Clears the selection or the cloud URL */}
                      {(stagedFiles.frontPreview || senderInfo.idFrontUrl) && (
                        <button onClick={() => clearImage('front')} className="btn-cross">✕</button>
                      )}
                    </div>

                    {stagedFiles.frontPreview && (
                      // <div className="preview-container">
                      //   <img src={stagedFiles.frontPreview} alt="Front Preview" style={{ width: '80px' }} />
                      //   {/* {senderInfo.idFrontUrl ? <span style={{ color: 'green' }}>✓ Cloud Ready</span>} */}
                      // </div>
                      <div className="preview-container" style={{ marginTop: '10px' }}>
                        <img 
                          src={stagedFiles.frontPreview} 
                          alt="Front Preview" 
                          onClick={() => setEnlargedImage(stagedFiles.frontPreview)} // Sets the state to this URL
                          style={{ 
                            width: '80px', 
                            height: 'auto', 
                            cursor: 'zoom-in', 
                ...
                {/* <div className="input-field">
                  ...
                  <input 
                    type="text" 
                    value={senderInfo.tId} 
                    onChange={(e) => updateSender('tId',  e.target.value)} 
                  />
                </div> */}
              ...
              <div className="form-column">
                ...
                {/* <div className="input-field">
                  ...
                  <p className="hint-text">No branch for selected country</p>
                </div> */}
                <div className="input-field">
                ...
                {/* <div className="checkbox-group">
                   <input type="checkbox" id="same" /> <label htmlFor="same">Billing Address Same as Address</label>
                </div> */}
              </div>
            </div>
          </>
              ...
              {pkg.cbm > 0 && (
                <div className="result-display">
                  ...
                  <div className="weight-conversion">
                    ...
                    <div className="badge">{((pkg.dims.l * pkg.dims.w * pkg.dims.h) / 5000).toFixed(2)} KG</div>
                    <div className="badge">{(((pkg.dims.l * pkg.dims.w * pkg.dims.h) / 5000) * 2.20462).toFixed(2)} LBS</div>
                  </div>
                </div>
              )}
            </div>
            ...
            <tbody>
              {pkg.items.map((item) => (
                <tr key={item.id}>
                  ...
                  <td><button className="delete-btn" onClick={() => removeItem(pkg.id, item.id)}>🗑️</button></td>
                </tr>
              ))}
            </tbody>
          </table>
