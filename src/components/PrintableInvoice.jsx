    ...
    <div id="printable-invoice" className="invoice-card" style={{ padding: '30px', background: '#fff', border: '1px solid #000', margin: '0 auto', maxWidth: '800px' }}>
      ...
      <table className="corp-invoice-table" style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px', marginBottom: '20px' }}>
        <thead>
          <tr style={{ background: '#f4f4f4', borderBottom: '2px solid #000' }}>
            <th style={{ width: '8%', padding: '8px', textAlign: 'left' }}>S.N</th>
            <th style={{ padding: '8px', textAlign: 'left' }}>Package Profile</th>
            <th style={{ width: '30%', padding: '8px', textAlign: 'left' }}>Package Type</th>
            <th style={{ width: '20%', padding: '8px', textAlign: 'center' }}>Weight (Kg)</th>
          </tr>
        </thead>
        <tbody>
          {packages.map((pkg, pkgIdx) => {
            ...
            return (
              <tr key={pkg.id || pkgIdx} style={{ borderBottom: '1px solid #ddd' }}>
                <td style={{ padding: '8px' }}>{pkgIdx + 1}</td>
                <td style={{ padding: '8px' }}>{pkg.profile || "Cargo Item"}</td>
                <td style={{ padding: '8px' }}>{pkg.type || "Parcel"}</td>
                <td style={{ padding: '8px', textAlign: 'center' }}>{packageWeight.toFixed(2)}</td>
              </tr>
            );
          })}
        </tbody>
